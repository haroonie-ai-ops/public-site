...
metaDescription: >-
  How haroonie.ai collects, uses and protects personal data, and how to
  exercise your data protection rights.
dataCollected: >-
  We collect personal data only when you choose to contact us: your name,
  email address, and the content of your message, submitted by email or
  (once enabled) via the contact form. Browsing this site itself does not
  set any cookies or tracking identifiers.
lawfulBasis: >-
  We process this information under the lawful basis of legitimate
  interests — responding to enquiries from people who have chosen to
  contact us — under the UK GDPR and the EU GDPR.
retentionPeriod: >-
  We keep enquiry correspondence for no longer than is necessary to respond
  and for a reasonable period afterward in case of follow-up, and delete it
  once it is no longer needed unless we are required to keep it longer by
  law.
rightsProcedure: >-
  You can ask to access, correct, delete, or restrict our use of your
